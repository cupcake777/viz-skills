...
| Font size | 16pt minimum for this skill suite; downsize only if the user explicitly requests journal-native tiny typography |
...
|----------|------------|--------------|
| Font base size | 16pt | 16pt |
| Axis line width | 0.5pt | 1.5pt |
| Point size | 0.5–1pt | 2–3pt |
| Legend text | 16pt minimum | 16pt minimum |
| Annotation text | 16pt minimum | 16pt minimum |
...
# Publication version
ggsave("fig1_pub.pdf", p + theme_sci(base_size = 16),
