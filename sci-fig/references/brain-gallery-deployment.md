...
- **Demo images**: `/gallery/static/` — FastAPI StaticFiles mount pointing to `/root/ops/plotting/`
- **Feedback API**: `POST /api/gallery/feedback` — writes to `/root/ops/plotting/gallery_feedback.jsonl`
